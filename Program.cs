...
namespace hw6._8
{
    ...
    class Area
    {
        private Warrior[] _warriors = { new Knight(500, 100, 75, 2, 3), new Barbarian(1100, 140, 40, 3), new Assassin(400, 70, 200, 2), new Mag(350, 100, 3, 250), new Archer(400, 90, 2) };
        ...
        public void Fight()
        {
            ...
            while(warrior1.Health > 0 && warrior2.Health > 0)
            {
                ...
                warrior1.ShowStats();
                warrior2.ShowStats();
                Warrior.ContinueMove();
                Console.ReadLine();
                Console.Clear();
            }

            ShowResult(warrior1, warrior2);
        }

        private void ChoiceFighters(ref Warrior warrior1, ref Warrior warrior2)
        {
            string userInput1 = "";
            string userInput2 = "";
            int result1 = 0;
            ...
            CheckInput(userInput1, userInput2, ref result1, ref result2);

            warrior1 = _warriors[result1 - 1];
            warrior2 = _warriors[result2 - 1];
            warrior1.ShowStats();
            warrior2.ShowStats();
        ...
        private void CheckInput(string userInput1, string userInput2, ref int result1, ref int result2)
        {
            bool isWork = true;
            ...
            while(isWork)
            {
                ...
                if(int.TryParse(userInput1, out result1) && int.TryParse(userInput2, out result2))
                {
        ...
        private void ShowResult(Warrior warrior1, Warrior warrior2)
        {
