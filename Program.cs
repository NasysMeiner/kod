...
namespace hw4._1
{
    internal class Program
    {
            ...
            while (isWork)
            {
                ...
                switch (key.Key)
                {
                    case ConsoleKey.D1:
                        ...
                        break;
                    case ConsoleKey.D2:
                        CallFile(fullNames, works);                        
                        break;
                    case ConsoleKey.D3:
                        DeleteFile(ref fullNames, ref works);
                        break;
                    case ConsoleKey.D4:
                        FindingFile(fullNames, works);
                        break;
                    case ConsoleKey.D5:
                        isWork = false;
                        break;
        ...
        static void ExpandArray(ref string[] arrayUp, string variable)
        {
        ...
        static void DereaceArray(ref string[] arrayDown, int variable)
        {
        ...
        static void AddFile(ref string[] fullNames, ref string[] works)
        {
            ...
            ExpandArray(ref fullNames, userInputName);
            ExpandArray(ref works, userInputPost);
        ...
        static void CallFile(string[] fullNames, string[] works)
        {
        ...
        static void DeleteFile(ref string[] fullNames, ref string[] works)
        {
            ...
            if (fullNames.Length > 0) 
            {
                ...
                DereaceArray(ref fullNames, number);
                DereaceArray(ref works, number);
        ...
        static void FindingFile(string[] nameSurName, string[] post)
        {
