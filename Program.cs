...
namespace hw6._8
{
    ...
    class Area
    {
        private Warrior[] _warriors = { new Knight(500, 100, 75, 2), new Barbarian(1000, 70, 35, 3), new Assassin(400, 70, 200), new Mag(350, 100, 3, 200), new Archer(400, 90, 2) };
        ...
        public void Fight()
        {
            ...
            Warrior warrior1 = _warriors[Convert.ToInt32(userInput1) - 1];
            Warrior warrior2 = _warriors[Convert.ToInt32(userInput2) - 1];
            warrior1.ShowStats();
            warrior2.ShowStats();
    ...
    class Warrior
    {
        ...
        public Warrior(double health, double damage, string name, int armor = 1)
        {
            Name = name;
            Health = health;
            BaseDamage = damage;
    ...
    class Knight : Warrior
    {
        ...
        public Knight(double health, int damage, int armor, int damageBaff) : base(health, damage, "Рыцарь", armor)
        {
        ...
        {
            if(MovesToAbility % 3 == 0 && MovesToAbility > 0)
            {
    ...
    class Assassin : Warrior
    {
        ...
        public Assassin(double health, int damage, int critDamage) : base(health, damage, "Ассасин")
        {
        ...
        public override double RecalculationDamage()
        {
            if(MovesToAbility % 2 == 0 && MovesToAbility > 1)
            {
